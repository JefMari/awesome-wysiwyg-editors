...
- [Adiptal Editor](https://github.com/adiptal/adiptal-editor) - `Free & Upgradable to Pro $ Non-Free Version` It is an iframe-based WYSIWYG Editor built on JavaScript. With advanced features & custom elements, it gives clean output to design responsive pages.
